...
namespace TableElementTests
{
    public class TableWithHeaderTests
    {
        ...
        private readonly string[][] expectedBodyMergedCells =
        {
            new[] {"c0r0", "c1r0", "c2r0"},
            new[] {"c0r1", "c1r1"},
            new[] {"c0r2", "c1r2", "c2r2"}
        ...
        private readonly string[] expectedHeader = {"h1", "h2", "h3"};
        ...
        public void CreateElement_NoHeader_ThrowsError()
        {
            ...
            Assert.Throws<HeaderMissMatchException>(
                () => new TableWithHeader(realTableNoHeader)
            );
        }
        ...
        public void CreateElement_ValidInput()
        {
            ...
            var tableElement = new TableWithHeader(realTableNoHeader);
